...
// ---- Ultrasonic helper (returns 0..14 cm scale, -1 if no echo) ----
long readUltrasonic(int trigPin, int echoPin) {
  ...
  long dist = (long)(us * 0.0343 / 2.0);  // actual distance in cm

  // --- limit scale between 0..14 ---
  if (dist > 14) dist = 14;    // cap at max 14 cm

  // --- invert the scale: 14 = close, 0 = far ---
  long mapped = 14 - dist;
